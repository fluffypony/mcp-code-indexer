...
Complete reference for all 8 MCP tools provided by the Code Indexer server. Each tool follows the Model Context Protocol standard and returns JSON responses.
